...
const { verificarToken, esAdmin, puedeGestionarEspecies } = require('../middleware/authMiddleware');
...
// CRUD
router.post('/', verificarToken, puedeGestionarEspecies, especieController.crear);
router.get('/', verificarToken, especieController.listar);
router.get('/:id', verificarToken, especieController.obtenerPorId);
router.put('/:id', verificarToken, puedeGestionarEspecies, especieController.actualizar);
